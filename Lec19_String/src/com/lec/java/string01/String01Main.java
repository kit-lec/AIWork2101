...
//		System.out.println(str1.charAt(20));
		...
		System.out.println(str10.replaceFirst("Language", "Java"));  // 첫 매칭만 치환		
				
		System.out.println();
		System.out.println("equals(), equalsIgnoreCase()");  // 문자열 비교
		String str11 = "Java";
		String str12 = "java";
		// 문자열 비교는 절.대.로 == 를 쓰지 마세요!!!!!!!!
		// reference type 끼리의 == 비교는 '주소' 비교하는것임
		
		System.out.println("HelloJava");
		System.out.println("Hello" + "Java");
		System.out.println("Hello".concat(str11));
		
		if("HelloJava" == "Hello" + "Java") {
			System.out.println("== 같아요");
		} else {
			System.out.println("== 달라요");
		}

		if("HelloJava" == "Hello".concat(str11)) {
			System.out.println("== 같아요");
		} else {
			System.out.println("== 달라요");
		}

		if("HelloJava".equals("Hello".concat(str11))) {
